...
static HCFSTAT g_Stat[] = {
	...
	HCF_STAT( HCF_ARENA_STATUS,					"ArenaStatus" ),
	HCF_STAT( HCF_MATCHES_PLAYED,				"MatchesPlayed" ),
	HCF_STAT( HCF_FRENZY_TIME,					"FrenzyTime" ),
	HCF_STAT( HCF_NICE_CATCH,					"NiceCatch" ),
	HCF_STAT( HCF_TANK_KILL,					"TankKill" ),
	HCF_STAT( HCF_MISS_COUNT,					"MissCount" ),
	HCF_STAT( HCF_HEALTH_REGEN,					"HealthRegen" ),
	HCF_STAT( HCF_KILL_STATUS1,					"KillStatus1" ),
	HCF_STAT( HCF_KILL_STATUS2,					"KillStatus2" ),
	HCF_STAT( HCF_KILL_STATUS3,					"KillStatus3" ),
	HCF_STAT( HCF_KILL_STATUS4,					"KillStatus4" ),
	HCF_STAT( HCF_KILL_STATUS5,					"KillStatus5" ),
	HCF_STAT( HCF_KILL_STATUS6,					"KillStatus6" ),
	HCF_STAT( HCF_KILL_STATUS7,					"KillStatus7" ),
	HCF_STAT( HCF_KILL_STATUS8,					"KillStatus8" ),
	HCF_STAT( HCF_COMBO_STATUS1,				"ComboStatus1" ),
	HCF_STAT( HCF_COMBO_STATUS2,				"ComboStatus2" ),
	HCF_STAT( HCF_COMBO_STATUS3,				"ComboStatus3" ),
	HCF_STAT( HCF_COMBO_STATUS4,				"ComboStatus4" ),
	HCF_STAT( HCF_COMBO_STATUS5,				"ComboStatus5" ),
	HCF_STAT( HCF_COMBO_STATUS6,				"ComboStatus6" ),
	HCF_STAT( HCF_COMBO_STATUS7,				"ComboStatus7" )
};
