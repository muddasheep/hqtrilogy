...
void W_Precache(void)
{
	...
	UTIL_PrecacheOtherWeapon("weapon_9mmARhqa");
	...
	g_sModelIndexWExplosion = PRECACHE_MODEL (EXPLOSION_PATH("/WXplo1.spr"));// underwater fireball
	...
	PRECACHE_SOUND(WEAPON_PATH("/explode3.wav"));
	PRECACHE_SOUND(WEAPON_PATH("/explode4.wav"));
	PRECACHE_SOUND(WEAPON_PATH("/explode5.wav"));
